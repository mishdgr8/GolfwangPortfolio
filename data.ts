...
export const projectsData: ProjectItem[] = [
  {
    ...
    longDescription: 'Engineered a modern web platform for TÉFA. Features immersive image galleries, CMS-driven articles, and a sophisticated dark-mode UI with fluid animations.',
    techStack: ['React', 'Next.js', 'Tailwind CSS', 'Framer Motion'],
    imageUrl: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=50&w=800&fm=webp',
    demoUrl: 'https://tefa-taupe.vercel.app/',
    repoUrl: 'https://github.com/mishdgr8/TEFA',
    date: 'Feb 2026',
    featured: true,
  },
  {
    id: 'project-raquel-ford',
    title: 'Raquel Ford',
    excerpt: 'An elegant, performance-optimized portfolio for a creative professional, featuring distinct typography and curated image grids.',
    longDescription: 'Developed a bespoke portfolio experience utilizing modern web standards. Focus is heavily placed on aesthetic hierarchy, load speeds, and SEO optimization.',
    techStack: ['React', 'TypeScript', 'Tailwind', 'Vite'],
    imageUrl: 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?auto=format&fit=crop&q=50&w=800&fm=webp',
    demoUrl: 'https://raquel-ford.vercel.app/',
    repoUrl: 'https://github.com/mishdgr8/Raquel_Ford',
    date: 'Feb 2026',
    featured: true,
  },
  {
    ...
    repoUrl: 'https://github.com/mishdgr8/golfwang0x-portfolio',
    date: 'Feb 2026',
    featured: true,
  },
  {
    id: 'project-based-trivia',
    title: 'BasedTrivia',
    excerpt: 'A mobile-first live trivia application with real-time scoring and dynamic game lobbies.',
    longDescription: 'Built the foundational architecture for a modern, real-time trivia game. Handles live socket connections, rapid state updates, and an engaging game loop tailored for competitive play.',
    techStack: ['React', 'Socket.io', 'Node.js', 'Tailwind CSS'],
    imageUrl: 'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?auto=format&fit=crop&q=50&w=800&fm=webp',
    repoUrl: 'https://github.com/mishdgr8/BasedTrivia',
    date: 'Feb 2026',
    featured: false,
  },
  {
    id: 'project-tempo-tone',
    title: 'Tempo & Tone',
    excerpt: 'An interactive web app blending audio visualization with synchronized UI feedback.',
    longDescription: 'Designed an experimental music interface that visualizes audio frequencies in real-time, mapping aural data to dynamic frontend aesthetic shifts.',
    techStack: ['Next.js', 'Web Audio API', 'Canvas', 'Tailwind'],
    imageUrl: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=50&w=800&fm=webp',
    repoUrl: 'https://github.com/mishdgr8/Tempo',
    date: 'Jan 2026',
    featured: false,
  },
  {
    id: 'project-sevenlabs',
    title: 'SevenLabs',
    excerpt: 'Corporate landing architecture focused on high conversion and bold, modern design token systems.',
    longDescription: 'Engineered a scalable marketing frontend for SevenLabs. Integrates complex scroll-based animations without compromising Core Web Vitals.',
    techStack: ['React', 'Tailwind', 'GSAP', 'Vite'],
    imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=50&w=800&fm=webp',
    repoUrl: 'https://github.com/mishdgr8/sevenlabs',
    date: 'Jan 2026',
    featured: false,
  }
];
